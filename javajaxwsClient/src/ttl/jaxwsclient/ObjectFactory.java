 ...
 * element interface generated in the ttl.jaxwsclient package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Add_QNAME = new QName("http://jaxws.ttl/",
			"add");
	private final static QName _SayHello_QNAME = new QName("http://jaxws.ttl/",
			"sayHello");
	private final static QName _SayHelloResponse_QNAME = new QName(
			"http://jaxws.ttl/", "sayHelloResponse");
	private final static QName _AddResponse_QNAME = new QName(
			"http://jaxws.ttl/", "addResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: ttl.jaxwsclient
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://jaxws.ttl/", name = "add")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://jaxws.ttl/", name = "sayHello")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://jaxws.ttl/", name = "sayHelloResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://jaxws.ttl/", name = "addResponse")
